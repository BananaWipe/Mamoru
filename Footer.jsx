        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="col-span-1 md:col-span-1">
            ...
            <p className="text-gray-400 text-sm">
              Protecting users from fraudulent websites with blockchain-verified community reports.
            </p>
          ...
          <div className="col-span-1">
            ...
            <ul className="space-y-2">
              ...
              <li>
                <Link to="/verify" className="text-gray-400 hover:text-white transition">Verify Website</Link>
              </li>
              <li>
                <Link to="/report" className="text-gray-400 hover:text-white transition">Report Fraud</Link>
              </li>
              <li>
          ...
          <div className="col-span-1">
            ...
            <ul className="space-y-2">
              ...
              <li>
                <a href="#" className="text-gray-400 hover:text-white transition">Browser Extension</a>
              </li>
              <li>
          ...
          <div className="col-span-1">
            ...
            <a 
              href="mailto:contact@fraudguard.io" 
