      ...
      <div className="container mx-auto px-4">
        <div className="max-w-3xl mx-auto">
          ...
          <p className="text-gray-600 mb-6">
            Help protect the community by reporting websites engaged in fraudulent activities. 
            All reports are verified and stored on the blockchain.
          </p>
          ...
          <div className="bg-gray-100 rounded-lg p-6 mt-6">
            ...
            <ul className="space-y-2 text-gray-700 text-sm">
              ...
              <li className="flex items-start">
                ...
                <span>Include screenshots or other evidence when possible</span>
              </li>
              <li className="flex items-start">
                <svg className="h-5 w-5 text-green-500 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M5 13l4 4L19 7" />
                </svg>
                <span>Report will be verified by community members</span>
              </li>
              <li className="flex items-start">
                <svg className="h-5 w-5 text-green-500 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M5 13l4 4L19 7" />
                </svg>
                <span>All reports are stored immutably on the blockchain</span>
              </li>
            </ul>
          </div>
        </div>
